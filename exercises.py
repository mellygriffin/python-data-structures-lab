...
def manage_students():
    class_list = ['Molly','Richard','Clint','Sarah','Dillain']
    first_student = class_list[0]
    last_student = class_list[4]
    return (f'{first_student} is the first and {last_student} is the last.')
...
# def combine_foods():
#     foods = ('apples','cupcakes','cheese','pickles','crackers')
#     meal = ''
#     for food in foods:
#         meal += food
#     return meal
...
#         'population': 1641,
#     }
#     home_town_message = print(f"I was born in {home_town['city']}, {home_town['state']} - population of {home_town['population']}.")
